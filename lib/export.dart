...
export "package:system_info/system_info.dart";
export 'dart:async';
...
// Kemap pour le masque sous la forme /24 en 255.255.255.0
const Map<int, String> cidrToMask = {
  8: "255.0.0.0",
  9: "255.128.0.0",
  10: "255.192.0.0",
  11: "255.224.0.0",
...
// List des 1000 ports les plus utilisé
const List<int> commonPort = [
  1,
  3,
  4,
  6,
